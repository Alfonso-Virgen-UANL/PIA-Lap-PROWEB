...
<body>
    ...
    <div class="layout">
        <aside class="side-nav">
            <ul>
                <li><a href="/PaginasUsuario/PerfilUsuario.html">Perfil</a></li>
                <li><a href="/PaginasUsuario/ConfPerfilUsuario.html">Configuración de la cuenta</a></li>
                <li><a href="/PaginasUsuario/SolicitarAlbumUsuario.html">Solicitar un album</a></li>
            </ul>
        </aside>
